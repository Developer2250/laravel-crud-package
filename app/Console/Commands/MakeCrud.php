...
class MakeCrud extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            // Run Migration
            if ($this->confirm('Do you want to refresh the database? This will delete all existing data.', true)) {
                $this->info("Running migrations...");
                Artisan::call('migrate', ['--force' => true]);
                //Artisan::call('migrate:fresh', ['--force' => true]);
                $this->info("migration file successfully!");
...
EOD;
            ...
            // 3. Optionally inject computed accessors
            $accessorMethods = '';
...
EOD;
            ...
            $stub = preg_replace(
                ...
                "$1{$fillableLine}{$relationshipMethods}{$accessorMethods}\n",
                $stub
            );

            File::put($modelPath, $stub);
            $this->info("Model generated for {$model} with relationships and accessors.");
            return true;
        } catch (\Exception $e) {
