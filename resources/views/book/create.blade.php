...
@enderror
    ...
    <div class="mb-3">
        ...
        <input type="text" name="author_id" id="author_id" class="form-control @error('author_id') is-invalid @enderror" placeholder="Enter {{ __('labels.author_id') }}" value="{{ old('author_id') }}">
@error('author_id')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
    </div>
