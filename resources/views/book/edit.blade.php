...
@enderror
    ...
    <div class="mb-3">
        ...
        <input type="text" name="author_id" id="author_id" class="form-control @error('author_id') is-invalid @enderror" placeholder="Enter {{ __('labels.author_id') }}" value="{{ old('author_id', $item->author_id) }}">
@error('author_id')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
    </div>
    <div class="mb-3">
        ...
        <input type="text" name="published_date" id="published_date" class="form-control @error('published_date') is-invalid @enderror" placeholder="Enter {{ __('labels.published_date') }}" value="{{ old('published_date', $item->published_date) }}">
